...
void soundmems() {                                                              // Here's where we capture sound. It provides an average, a current sample as well as a peak trigger.
  ...
  // Local definitions
#define sensitivity 255                                                       // Define maximum cutoff of potentiometer for cutting off sounds.
#define DC_OFFSET  256                                                        // DC offset in mic signal. I subtract this value from the raw sample of a 'quiet room' test.
#define NSAMPLES 64                                                           // Creating an array of lots of samples for decent averaging.
  ...
  //potin = 30                                                                  // C'est moche mais ça peut marcher sans potard. Et ça filtre les sons en dessous de ce seuil.
